...
function Fixture() {
  ...
  return <GameContext.Provider value={{ state, multiplayer: {}, dispatch: command => setCommands(old => [...old, command]), dispatchInBackground: () => setBackgroundStarts(n => n + 1), cancelBackgroundDispatch: () => setBackgroundStops(n => n + 1) }}>
    ...
    <HoverProvider>
      ...
      <output data-background>{JSON.stringify({ starts: backgroundStarts, stops: backgroundStops })}</output>
