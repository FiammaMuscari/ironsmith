...
mod tests {
    ...
    fn test_queue_triggers_tracks_life_gained_this_turn() {
        ...
        let event = TriggerEvent::new_with_provenance(LifeGainEvent::new(alice, 5), crate::provenance::ProvNodeId::UNKNOWN);
        queue_triggers_from_event(&mut game, &mut trigger_queue, event, false);
    ...
    fn test_queue_triggers_tracks_life_lost_this_turn() {
        ...
        let event = TriggerEvent::new_with_provenance(LifeLossEvent::from_effect(bob, 3), crate::provenance::ProvNodeId::UNKNOWN);
        queue_triggers_from_event(&mut game, &mut trigger_queue, event, false);
    ...
    fn test_stangg_linked_twin_sacrifice_survives_legend_rule_for_other_twin() {
        ...
        for source in [stangg_a, stangg_b] {
            ...
            let event = TriggerEvent::new_with_provenance(EnterBattlefieldEvent::new(source, Zone::Hand), crate::provenance::ProvNodeId::UNKNOWN);
            let mut ctx =
    ...
    fn test_stormbreath_dragon_trigger_condition() {
        ...
        let event = TriggerEvent::new_with_provenance(BecameMonstrousEvent::new(dragon_id, alice, 3), crate::provenance::ProvNodeId::UNKNOWN);
